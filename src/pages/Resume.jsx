    ...
    <article>
      <div className="flex flex-wrap justify-center mb-8 gap-8 items-center">
        <div className="px-4">
          ...
          <div className="flex flex-col bg-background text-black p-8 md:max-w-xl">
      ...
      <div className="flex flex-wrap justify-center mb-8 gap-8 items-center px-4">
        <div className="self-stretch bg-background text-black p-8 mt-8 lg:max-w-xl xl:max-w-lg">
